...
$(function () {
    ...
    $body.on('click', '[data-file]', function () {
        ...
        var url = window.ROOT_URL + '/admin.php/admin/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field;
    ...
    $body.on('click', '[data-icon]', function () {
        ...
        var url = window.ROOT_URL + '/admin.php/admin/plugs/icon.html?field=' + field;
