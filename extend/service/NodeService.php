...
class NodeService
{
    ...
    public static function get($nodes = [])
    {
        ...
        $ignore = ['index', 'home','wechat/review', 'admin/plugs', 'admin/login', 'admin/index'];
        $inauth = ['admin/index/main','registermiddleware'];
        foreach (self::getNodeTree(env('app_path')) as $thr) {
            if(!in_array($thr,$inauth)){
