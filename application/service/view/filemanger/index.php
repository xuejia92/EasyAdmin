...
$CONFIG = '{"lang":"simpch","error_reporting":false,"show_hidden":false}';
...
$all_files_size = 0;
?>
<form action="" method="post" class="pt-3" style="margin-top: -33px;">
    <input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
...
<head>
    ...
    <style>
        ...
        .fm-login-page .brand{width:121px;overflow:hidden;margin:0 auto;margin:5px auto;margin-bottom:0;position:relative;z-index:1}
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = '文件管理中心';
    $tr['en']['Login']          = 'Sign in';                $tr['en']['Username']           = 'Username';
    $tr['en']['Password']       = 'Password';               $tr['en']['Logout']             = 'Sign Out';
    $tr['en']['Move']           = 'Move';                   $tr['en']['Copy']               = 'Copy';
    $tr['en']['Save']           = 'Save';                   $tr['en']['SelectAll']          = 'Select all';
    $tr['en']['UnSelectAll']    = 'Unselect all';           $tr['en']['File']               = 'File';
    $tr['en']['Back']           = 'Back';                   $tr['en']['Size']               = '文件大小';
    $tr['en']['Perms']          = '文件权限';                  $tr['en']['Modified']           = '最后修改时间';
    $tr['en']['Owner']          = '所有者';                  $tr['en']['Search']             = 'Search';
    $tr['en']['NewItem']        = '新项目';               $tr['en']['Folder']             = 'Folder';
    $tr['en']['Delete']         = 'Delete';                 $tr['en']['Rename']             = 'Rename';
    $tr['en']['CopyTo']         = 'Copy to';                $tr['en']['DirectLink']         = 'Direct link';
    $tr['en']['UploadingFiles'] = 'Upload Files';           $tr['en']['ChangePermissions']  = 'Change Permissions';
    $tr['en']['Copying']        = 'Copying';                $tr['en']['CreateNewItem']      = 'Create New Item';
    $tr['en']['Name']           = '文件名称';                   $tr['en']['AdvancedEditor']     = 'Advanced Editor';
    $tr['en']['RememberMe']     = 'Remember Me';            $tr['en']['Actions']            = '操作';
    $tr['en']['Upload']         = '上传';                 $tr['en']['Cancel']             = 'Cancel';
